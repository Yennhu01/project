...
const brandsWithIcon = [
  ...
  { id: "puma", label: "Celine", icon: Origami },
  { id: "levi", label: "YSL", icon: Dog },
  { id: "zara", label: "Vivienne Westwood ", icon: Turtle },
  { id: "h&m", label: "Ralph Lauren", icon: Snail },
];
...
function ShoppingHome() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-8">Sản phẩm theo thương hiệu</h2>
